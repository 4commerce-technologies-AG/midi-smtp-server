...
module MidiSmtpServer
  ...
  DEFAULT_IO_WAITREADABLE_TIMEOUT = 0.1
  ...
  class Smtpd
    ...
    attr_reader :io_waitreadable_timeout
    ...
    # +io_waitreadable_timeout+:: time in seconds to sleep on IO::WaitReadable exception (DEFAULT_IO_WAITREADABLE_TIMEOUT)
    ...
    def initialize(
      ...
      io_waitreadable_timeout: DEFAULT_IO_WAITREADABLE_TIMEOUT,
      io_cmd_timeout: nil,
      ...
      @io_waitreadable_timeout = io_waitreadable_timeout
